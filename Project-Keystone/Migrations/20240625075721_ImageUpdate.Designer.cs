...
namespace Project_Keystone.Migrations
{
    ...
    [Migration("20240625075721_ImageUpdate")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "bc042b0b-70b5-4513-b531-a25d75c2b5db",
            ...
            modelBuilder.Entity("Project_Keystone.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bc042b0b-70b5-4513-b531-a25d75c2b5db",
                            ConcurrencyStamp = "d591e4d6-4422-45b8-b697-deaa641bc801",
                            CreatedAt = new DateTime(2024, 6, 25, 7, 57, 20, 776, DateTimeKind.Utc).AddTicks(7002),
                            Email = "admin@example.com",
                            Firstname = "Admin",
                            Lastname = "User",
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN@EXAMPLE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEBuDz5jrkbTZnVZ83S2YztNZc9YBolT9yuuTFJkg7l4wom8CZkX1WuQ3ezb9Qr+Ulg==",
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(2024, 6, 25, 7, 57, 20, 776, DateTimeKind.Utc).AddTicks(7003),
            ...
            modelBuilder.Entity("Project_Keystone.Core.Entities.Product", b =>
                {
                    b.HasOne("Project_Keystone.Core.Entities.Category", "Category")
                        .WithOne("Product")
                        .HasForeignKey("Project_Keystone.Core.Entities.Product", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
